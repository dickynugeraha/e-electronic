            ...
            <form action="/product/update" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <div class="mb-2">
                  ...
                  <select name="type" id="type" class="form-select">
                    <option value="">Choose one</option>
                    <option {{$product->type == "sling_bag" ? "selected" : ""}} value="sling_bag">Sling Bag</option>
                    <option {{$product->type == "crossbody_bag" ? "selected" : ""}} value="crossbody_bag">Crossbody Bag</option>
                    <option {{$product->type == "tote_bag" ? "selected" : ""}} value="tote_bag">Tote Bag</option>
                    <option {{$product->type == "hand_bag" ? "selected" : ""}} value="hand_bag">Hand Bag</option>
                    <option {{$product->type == "serut_bag" ? "selected" : ""}} value="serut_bag">Serut Bag</option>
                    <option {{$product->type == "goodie_bag" ? "selected" : ""}} value="goodie_bag">Goodie Bag</option>
                  </select>
                </div>
                <div class="mb-2">
                  <label for="price" class="form-label">Price</label>
